      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="curso in cursos">
            ...
            <td>{{ curso.a_hours }}</td>
            <td>{{ curso.d_hours }}</td>
            <td><button class="btn btn-danger" v-on:click="deleteCourse(curso.id)"><i
                  class="fa-solid fa-trash"></i></button></td>
            <td><router-link :to="('/courses/edit/' + curso.id)"><i class="fa-solid fa-pen-to-square"
                  style="color: darkgoldenrod"></i></router-link></td>
          </tr>
        </tbody>
      </table>
    </div>
